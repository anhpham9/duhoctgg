    ...
    <div class="news-content-page">
        <div v-if="loadingUser || !hasPermission" class="permission-check">
            ...
            <div v-else class="permission-denied">
                ...
                <h3>Không thể truy cập Quản lý nội dung News</h3>
            ...
            <div class="page-header">
                <div class="header-content">
                    <h1>
                        ...
                        Quản lý nội dung News
                    </h1>
                    <p>Cập nhật SEO, hero và nội dung chi tiết cho trang News.</p>
                </div>
...
useHead({
    title: 'Quản lý nội dung News - Admin'
})
        ...
        if (!response.ok) {
            if (response.status === 404) {
                applyForm({
                    title: 'Tin tức',
                    slug: PAGE_SLUG,
                    hero_title: 'Tin tức DuhocNB',
                    hero_description: 'Các tin tức và thông tin cập nhật từ DuhocNB.',
                    meta_title: 'Tin tức - DuhocNB',
                    meta_description: 'Thông tin về các tin tức và cập nhật từ DuhocNB.',
                    type: 'dynamic',
                    status: 'published',
                    content: ''
                })
...
const savePageData = async () => {
    ...
    try {
        ...
        showSuccess(data?.message || 'Đã lưu nội dung trang news thành công')
    } catch (error) {
        showError(error.message || 'Không thể lưu nội dung trang news')
    } finally {
        saving.value = false
    }
}
