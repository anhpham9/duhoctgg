<template>
    <div class="conditions-content-page">
        <div v-if="loadingUser || !hasPermission" class="permission-check">
            ...
            <div v-else class="permission-denied">
                ...
                <h3>Không thể truy cập Quản lý nội dung Conditions</h3>
            ...
            <div class="page-header">
                <div class="header-content">
                    <h1>
                        ...
                        Quản lý nội dung Conditions
                    </h1>
                    <p>Cập nhật SEO, hero và nội dung chi tiết cho trang Conditions.</p>
                </div>
            ...
            <div v-else class="form-layout">
                <div class="content-section">
                    <div class="section-header">
                        ...
                        <p>Thông tin tổng quan của page</p>
                    </div>
                ...
                <div v-if="!isDynamicPage" class="content-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            <label>Content</label>
                            <textarea v-model="form.content" class="form-control content-editor" rows="16" placeholder="Nhập nội dung trang Conditions..."></textarea>
...
useHead({
    title: 'Quản lý nội dung Conditions - Admin'
})

const PAGE_SLUG = 'conditions'
        ...
        if (!response.ok) {
            if (response.status === 404) {
                applyForm({
                    title: 'Điều khoản',
                    slug: PAGE_SLUG,
                    hero_title: 'Điều khoản sử dụng DuhocNB',
                    hero_description: 'Các điều khoản và điều kiện áp dụng khi sử dụng dịch vụ của DuhocNB.',
                    meta_title: 'Điều khoản - DuhocNB',
                    meta_description: 'Thông tin về các điều khoản và điều kiện sử dụng dịch vụ của DuhocNB.',
                    type: 'dynamic',
                    status: 'published',
                    content: ''
                })
...
const savePageData = async () => {
    ...
    try {
        ...
        showSuccess(data?.message || 'Đã lưu nội dung trang conditions thành công')
    } catch (error) {
        showError(error.message || 'Không thể lưu nội dung trang conditions')
    } finally {
        saving.value = false
    }
}
