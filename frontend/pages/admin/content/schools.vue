    ...
    <div class="schools-content-page">
        <div v-if="loadingUser || !hasPermission" class="permission-check">
            ...
            <div v-else class="permission-denied">
                ...
                <h3>Không thể truy cập Quản lý nội dung Schools</h3>
            ...
            <div class="page-header">
                <div class="header-content">
                    <h1>
                        ...
                        Quản lý nội dung Schools
                    </h1>
                    <p>Cập nhật SEO, hero và nội dung chi tiết cho trang Schools.</p>
                </div>
            ...
            <div v-else class="form-layout">
                <div class="content-section">
                    <div class="section-header">
                        ...
                        <p>Thông tin tổng quan của trang Schools</p>
                    </div>
                ...
                <div v-if="!isDynamicPage" class="content-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            <label>Content</label>
                            <textarea v-model="form.content" class="form-control content-editor" rows="16" placeholder="Nhập nội dung trang Schools..."></textarea>
...
useHead({
    title: 'Quản lý nội dung Schools - Admin'
})

const PAGE_SLUG = 'schools'
        ...
        if (!response.ok) {
            if (response.status === 404) {
                applyForm({
                    title: 'Trường học',
                    slug: PAGE_SLUG,
                    hero_title: 'Trường học DuhocNB',
                    hero_description: 'Các thông tin về trường học và cập nhật từ DuhocNB.',
                    meta_title: 'Trường học - DuhocNB',
                    meta_description: 'Thông tin về các trường học và cập nhật từ DuhocNB.',
                    type: 'dynamic',
                    status: 'published',
                    content: ''
                })
...
const savePageData = async () => {
    ...
    try {
        ...
        showSuccess(data?.message || 'Đã lưu nội dung trang schools thành công')
    } catch (error) {
        showError(error.message || 'Không thể lưu nội dung trang schools')
    } finally {
        saving.value = false
    }
}
