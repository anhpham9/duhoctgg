    ...
    <div class="contact-content-page">
        <div v-if="loadingUser || !hasPermission" class="permission-check">
            ...
            <div v-else class="permission-denied">
                ...
                <h3>Không thể truy cập Quản lý nội dung Contact</h3>
        ...
        <div v-else>
            <div class="page-header">
                <div class="header-content">
                    ...
                    <p>Cập nhật SEO, hero và nội dung chi tiết cho trang Contact.</p>
                </div>
            ...
            <div v-else class="form-layout">
                ...
                <div v-if="!isDynamicPage" class="content-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            <label>Content</label>
                            <textarea v-model="form.content" class="form-control content-editor" rows="16" placeholder="Nhập nội dung trang Contact..."></textarea>
...
useHead({
    title: 'Quản lý nội dung Contact - Admin'
})
...
const savePageData = async () => {
    ...
    try {
        ...
        showSuccess(data?.message || 'Đã lưu nội dung trang contact thành công')
    } catch (error) {
        showError(error.message || 'Không thể lưu nội dung trang contact')
    } finally {
        saving.value = false
    }
}
