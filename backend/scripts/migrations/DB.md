...
CREATE INDEX idx_media_asset_refs_owner ON media_asset_refs(owner_type, owner_key);
CREATE INDEX idx_media_asset_refs_field ON media_asset_refs(field_name);
```
