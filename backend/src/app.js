...
import { getPublicFooter, getPublicGeneralSettings, getPublicSeoSettings } from './controllers/publicSettings.controller.js';
...
app.get('/api/public/seo-settings', getPublicSeoSettings);
