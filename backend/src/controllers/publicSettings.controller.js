...
import { getPublicFooterData, getPublicGeneralSettingsData, getPublicSeoSettingsData } from "../services/settings.service.js";
...
export const getPublicSeoSettings = async (req, res) => {
    try {
        const data = await getPublicSeoSettingsData();
        ...
        logError("Get public SEO settings failed", error, {
            ip: req.ip
        });
